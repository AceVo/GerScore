<Serializable> Public Class clsEditorPart
    ...
    Overrides Sub Dispose(ByVal disposing As Boolean)
        clsProgram.DebugPrefix += 1 : Debug.Print(StrDup(clsProgram.DebugPrefix, "+") & " " & "Enter in: {0} Sub ->  {1}", "clsEditorPart", "Dispose")
        If Not disposing Then
            ...
            _disposed = True
        End If
        Debug.Print(StrDup(clsProgram.DebugPrefix, "+") & " " & "Leave in: {0} Sub ->  {1}", "clsEditorPart", "Dispose") : clsProgram.DebugPrefix -= 1
    End Sub
